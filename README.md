...
A front-end e-commerce website built with **HTML**, **CSS**, and **JavaScript**.
...
Open `index.html` in your browser, or deploy with [GitHub Pages](https://pages.github.com/) from this repository.
